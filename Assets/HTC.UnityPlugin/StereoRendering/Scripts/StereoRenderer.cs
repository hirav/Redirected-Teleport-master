...
namespace HTC.UnityPlugin.StereoRendering
{
    ...
    public class StereoRenderer : MonoBehaviour
    {
       ...
       // [SerializeField]
        public Vector3 m_canvasOriginWorldPosition = new Vector3(0.0f, 0.0f, 0.0f);
        //[SerializeField]
        public Vector3 m_canvasOriginWorldRotation = new Vector3(0.0f, 0.0f, 0.0f);
        ...
        public void MoveStereoCameraBasedOnHmdPose()
        {
            ...
            else
            {
                ...
                //stereoCameraHead.transform.position = new Vector3(stereoCameraHead.transform.position.x, mainCamPos.y, stereoCameraHead.transform.position.z);
