            ...
            if (shouldTeleport || shouldCancel)
            {
                ...
                if (shouldTeleport && Pointer.PointOnNavMesh)
                {
                    ...
                    */
                    ...
                    //teleport location direction as unit vector
                    Vector3 teleportDirection = Pointer.SelectedPoint - HeadTransform.position;
                    ...
                    //move portal
                    PortalTransform.position = HeadTransform.position + (HeadTransform.forward * 1f) - new Vector3(0, 1, 0);//headPosition + teleportDirection;
